...
BRUSHED.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											...
											{image : 'assets/_include/img/slider-images/image02.jpg', title : '<div style="margin-top:  -30px; font-size: 3.0em; font-family: Titillium Web, sans-serif">Anda bisa memotret barang tertinggal milik orang lain</div><div style="margin-top: -180px; font-size: 3.0em; font-family: Titillium Web, sans-serif">yang Anda temukan</div>', thumb : '', url : ''},
											...
											{image : 'assets/_include/img/slider-images/image04.jpg', title : '<div style="margin-top:  -30px; font-size: 3.0em; font-family: Titillium Web, sans-serif">Anda juga bisa mencari barang Anda yang mungkin ditemukan</div><div style="margin-top: -180px; font-size: 3.0em; font-family: Titillium Web, sans-serif">orang lain</div>', thumb : '', url : ''},
