        ...
        <div class="row">
                ...
                <!-- Filter -->
                    <nav id="options" class="work-nav">
                        <ul id="filters" class="option-set" data-option-key="filter">
                            ...
                            <li class="type-work">Password</li>
            ...
            <?php foreach($user as $users) ?>
                ...
                <form class="form-inline" action="<?php echo base_url(); ?>dashboard/editPenggunaProfil" method="POST" name="barangForm" id="barangForm" enctype="multipart/form-data">
                    <nav id="options" class="work-nav">
                        <ul id="filters" class="option-set" data-option-key="filter">
                            <li class="type-work" style="margin-top: 0px; margin-bottom: 4%;"><input type="text" style="width: 97%; height: 80%;" name="nama_pengguna" placeholder="nama pengguna" value="<?php echo $users->NAMA_PGN ?>"></li>
                            <li class="type-work" style="margin-top: 0px; margin-bottom: 5%;"><input type="text" style="width: 97%; height: 80%;" name="email" placeholder="email" value="<?php echo $users->EMAIL_PGN ?>"></li>
                            <li class="type-work" style="margin-top: 0px; margin-bottom: 5%;"><input type="password" style="width: 97%; height: 80%;" name="password" placeholder="password" value="<?php echo $users->PSWD_PGN ?>"></li>
                            <li class="type-work" style="margin-top: 0px; margin-bottom: 5%;"><input type="text" style="width: 97%; height: 80%;" name="no_telpon" placeholder="nomor telepon" value="<?php echo $users->NOTLP_PGN ?>"></li>
                            <li class="type-work" style="margin-top: 0px; margin-bottom: 5%;"><textarea type="text" rows="5" style="width: 97%; height: 80%; " name="alamat" placeholder="alamat anda ..."><?php echo $users->ALAMAT_PGN ?></textarea></li>
                        </ul>
                    </nav>
                <!-- End Filter -->
            </div>
